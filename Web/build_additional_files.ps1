...
if (Test-Path "${dir}/global/error")
  ...
  if (Test-Path "${dir}/global/error/2dr3drn_ys.png")
    {"Copying global/error/2dr3drn_ys.png file"
    Copy-Item "${dir}/global/error/2dr3drn_ys.png" "${PSScriptRoot}/additional_files/global/error/" -Force}
